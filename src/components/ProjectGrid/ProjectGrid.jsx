...
const ProjectGridItem = memo(({ project, index, isMobile, isTablet, activeCard, onCardClick }) => (
    <motion.div
        className={`
            ...
            ${!isMobile && !isTablet && index !== 0 ? "-mt-12 lg:-mt-16" : ""}
            relative
        `}
...
const ProjectCard = memo(({
    ...
    const getCardSize = useCallback(() => {
        ...
        if (isTablet) return "w-[300px] h-[300px]";
        return "w-[340px] h-[340px]";
    }, [isMobile, isTablet]);
...
const RemainingProjectsRow = memo(() => {
    ...
    return (
        <motion.div
            className="w-full flex flex-col items-center mt-12 sm:mt-16"
            {...containerVariants}
            viewport={{ once: true }}
        >
                ...
                {remainingProjects.map((project, idx) => (
                    ...
                    >
                        <img
                            ...
                            className="w-28 h-20 md:w-32 md:h-24 object-contain"
                        />
                    </motion.div>
                ))}
            </div>
