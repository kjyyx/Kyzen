...
const projectData = {
    ...
    // Project links
    links: {
        website: "https://www.Railroaded.com",
...
const screenshots = [
    {
        src: "../src/assets/Webpage_Screenshots/RE (1).png",
        alt: "Railroad-ed Homepage Fullpage Screenshot"
    },
    {
        src: "../src/assets/Webpage_Screenshots/RE (2).png",
        alt: "Railroad-ed Features Fullpage Screenshot"
    },
    {
        src: "../src/assets/Webpage_Screenshots/RE (3).png",
        alt: "Railroad-ed Articles Fullpage Screenshot"
    },
    {
        src: "../src/assets/Webpage_Screenshots/RE (4).png",
        alt: "Railroad-ed Gallery Fullpage Screenshot"
    },
    {
        src: "../src/assets/Webpage_Screenshots/RE (5).png",
        alt: "Railroad-ed Contact Fullpage Screenshot"
    },
];
...
// Add this new component above the main Railroaded function/component
...
export default memo(Railroaded);