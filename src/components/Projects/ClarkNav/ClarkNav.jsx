...
const projectData = {
    ...
    techStack: [
        ...
        { name: "AWS", color: "#ff9900", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/amazonwebservices/amazonwebservices-original-wordmark.svg" },
                    ...
                    >
                        ...
                        <div className="prose prose-lg prose-invert">
                            <p className="text-foreground-secondary/90 text-sm sm:text-base leading-relaxed mb-6">
                                This comprehensive navigation enhancement project represents a complete transformation
                                of user interaction paradigms. Through meticulous research, innovative design approaches,
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
                    {projectData.techStack.map((tech, index) => (
                        <motion.div
                            ...
                            whileHover={{ y: -2, scale: 1.01 }}
                        >
                            <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md border border-white/20 rounded-2xl p-6 text-center hover:bg-white/15 hover:border-white/30 transition-all duration-300 group-hover:shadow-lg shadow-brand-light/10">
                                <div
                                    className="w-8 h-8 rounded-xl mx-auto mb-4 flex items-center justify-center font-display-heavy text-display text-xl bg-white/5"
                                ...
                                <h3 className="text-display font-display-black-italic mb-1">{tech.name}</h3>
                                <div
...
function ClarkNav() {
    ...
    return (
        <div className="min-h-screen relative overflow-hidden">
            ...
            >
                {/* Project Title - positioned outside image container */}
                <motion.div
