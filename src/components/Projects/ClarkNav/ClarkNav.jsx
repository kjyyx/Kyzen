            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
                    {projectData.techStack.map((tech, index) => (
                        ...
                        >
                            <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md border border-white/20 rounded-2xl p-6 text-center hover:bg-white/15 hover:border-white/30 transition-all duration-300 group-hover:shadow-2xl shadow-[#ff75df]/10">
                                <div
