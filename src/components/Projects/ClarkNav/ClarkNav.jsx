            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
                    {projectData.techStack.map((tech, index) => (
                        ...
                        >
                            <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md border border-white/20 rounded-2xl p-6 text-center hover:bg-white/15 hover:border-white/30 transition-all duration-300 group-hover:shadow-2xl shadow-brand-light/10">
                                <div
                                    className="w-12 h-12 rounded-xl mx-auto mb-4 flex items-center justify-center font-black text-white text-xl bg-white/5"
                                ...
                                <h3 className="text-white font-black italic mb-1">{tech.name}</h3>
                                <div
